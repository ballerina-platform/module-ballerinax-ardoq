...
service /api/v2 on ep0 {
    ...
    #
    # + return - Success
    resource function post batch(@http:Payload json payload) returns BatchResponse {
        return {
            components: {
    ...
    #
    # + return - Success
    resource function post batch/expand(@http:Payload json payload) returns BatchRequest {
        return {
            components: {
                create: [
                    {
